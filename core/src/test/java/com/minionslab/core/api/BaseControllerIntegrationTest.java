...
import static com.minionslab.core.api.BaseControllerIntegrationTest.PrivilegeLevel.NO;
import static com.minionslab.core.test.TestConstants.CONTEXT_TEXT;
import static com.minionslab.core.test.TestConstants.GUIDELINES_TEXT;
import static com.minionslab.core.test.TestConstants.POLICY_TEXT;
import static com.minionslab.core.test.TestConstants.REFLECTION_TEXT;
import static com.minionslab.core.test.TestConstants.TASK_SPECIFIC_TEXT;
import static com.minionslab.core.test.TestConstants.TEST_COMPONENT_ORDER;
...
import static com.minionslab.core.test.TestConstants.TEST_COMPONENT_WEIGHT;
import static com.minionslab.core.test.TestConstants.TEST_PROMPT_CONTENT;
...
import static com.minionslab.core.test.TestConstants.USER_TEMPLATE_TEXT;
import static com.minionslab.core.test.TestConstants.getPromptComponent;
...
import com.minionslab.core.config.TestSecurityConfig;
...
public abstract class BaseControllerIntegrationTest {
  ...
  private void setupRestTemplates() {
    restTemplates.put(PrivilegeLevel.HIGH, new TestRestTemplate("admin", "password", HttpClientOption.ENABLE_COOKIES));
    restTemplates.put(LOW, new TestRestTemplate("user", "password", HttpClientOption.ENABLE_COOKIES));

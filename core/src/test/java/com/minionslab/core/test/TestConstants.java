...
public final class TestConstants {
  ...
  // Prompt
  public static final String TEST_PROMPT_ENTITY_ID = "entity-id";
  public static final String TEST_PROMPT_ID = "test-id";
  public static final String TEST_PROMPT_DESCRIPTION = "Test Prompt";
